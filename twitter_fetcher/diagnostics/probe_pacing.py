...
NO production code is modified. Output: diagnostics/reports/pacing_<ts>.{json,md}.

Run:
    python twitter_fetcher/diagnostics/probe_pacing.py
    python twitter_fetcher/diagnostics/probe_pacing.py --endpoints SearchTimeline \\
        --queries OpenAI --pages 8
    python twitter_fetcher/diagnostics/probe_pacing.py --regimes human:9:4 steady:3:1 rapid:0.3:0
"""
