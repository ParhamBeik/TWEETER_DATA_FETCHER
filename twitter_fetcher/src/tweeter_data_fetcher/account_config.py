...
"""
Account tier and rolling-window policy configuration.
...
from tweeter_data_fetcher.paths import CONFIG_DIR, PROJECT_ROOT
        ...
        if config is None:
            if config_path:
                ...
                if not path.is_absolute():
                    # اگر مسیری داده شد، آن را نسبت به PROJECT_ROOT (paths.py) پیدا کن
