...
class TwitterLiveMonitor:
    ...
    def fetch_latest_tweets(
        ...
        self.fetcher._attach_conversation_context(only)
        self.fetcher._attach_conversation_context(replies_only)
        self.fetcher._attach_conversation_context(merged)
        self.fetcher._attach_conversation_context(diffs)
