...
class StorageManagerTests(unittest.TestCase):
    ...
    def test_search_subsystem_does_not_create_historical_processed_dirs(self):
        ...
        StorageManager(base_dir=Path(self.temp_dir), timezone="UTC", subsystem="search", create_folders=True)
    ...
    def test_prune_raw_batches_keeps_newest(self):
        ...
        remaining = [p.name for p in self.storage.find_raw_batches("UserTweets", "testuser")]
