...
Command-line arguments remain available as optional one-off overrides:
    ...
    python tools/diagnostics/traffic_sniffer.py elonmusk --timeout 90
    python tools/diagnostics/traffic_sniffer.py https://x.com/elonmusk/with_replies
    python tools/diagnostics/traffic_sniffer.py https://x.com/home --timeout 300 --include-all-graphql
...
def _write_playbook(
    ...
    lines.append("   ```")
    lines.append("   python tools/diagnostics/traffic_sniffer.py <target> --timeout 90")
    lines.append("   ```")
    lines.append(
