...
from src.shared.auth.browser_context import BrowserBootstrap, BrowserBootstrapResult
...
class FetcherEngine:
    ...
    def _recover_404_context(
        ...
        *,
        ...
        # via src/shared/auth/auto_refresh.py.
        self.logger.warning(
...
def main():
    engine = FetcherEngine(config_path="src/shared/config/config.json")
    engine.run()
