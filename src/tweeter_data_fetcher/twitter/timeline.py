...
Run:
    python -m tweeter_data_fetcher.twitter.timeline
...
from tweeter_data_fetcher.twitter.contracts import (
...
from tweeter_data_fetcher.twitter.browser import BrowserBootstrap, BrowserBootstrapResult
from tweeter_data_fetcher.tweets.windows import RollingWindowEvaluator
...
from tweeter_data_fetcher.twitter.contract_verification import verify_contract
...
class TimelineFetcher:
    ...
    def __init__(
        ...
        try:
            ...
            if drift:
                ...
                from tweeter_data_fetcher.twitter.auth import auto_refresh_session
    ...
    def _recover_404_context(
        ...
        *,
        ...
        # via tweeter_data_fetcher/twitter/auth.py.
        self.logger.warning(
